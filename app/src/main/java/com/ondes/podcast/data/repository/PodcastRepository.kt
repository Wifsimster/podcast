package com.ondes.podcast.data.repository

import com.ondes.podcast.data.local.DownloadState
import com.ondes.podcast.data.local.EpisodeDao
import com.ondes.podcast.data.local.EpisodeEntity
import com.ondes.podcast.data.local.PodcastDao
import com.ondes.podcast.data.local.PodcastEntity
import com.ondes.podcast.data.local.PodcastWithCount
import com.ondes.podcast.data.local.Chapter
import com.ondes.podcast.data.local.QueueDao
import com.ondes.podcast.data.local.QueueItemEntity
import com.ondes.podcast.data.remote.ParsedFeed
import com.ondes.podcast.data.remote.PodcastSearchResult
import com.ondes.podcast.data.remote.PodcastSearchService
import com.ondes.podcast.data.remote.RssParser
